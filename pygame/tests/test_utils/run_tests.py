...
if is_pygame_pkg:
    ...
    from 希冀python练习6_19.test_utils import import_submodule
    from 希冀python练习6_19.test_utils.test_runner \
         import prepare_test_env, run_test, combine_results, \
                get_test_results, TEST_RESULTS_START
import pygame
...
def run(*args, **kwds):
    ...
    #
        ...
        if is_pygame_pkg:
            ...
            from 希冀python练习6_19.test_utils.async_sub import proc_in_time_or_kill
